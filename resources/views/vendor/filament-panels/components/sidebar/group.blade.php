...
<li
    ...
    x-init="if (@js($active) && $store.sidebar.groupIsCollapsed(label)) $store.sidebar.toggleCollapsedGroup(label)"
    ...
    >
        @foreach ($items as $item)
            @php
                ...
                // Renome shows meaningful icons for both sections and their destinations.
            @endphp
