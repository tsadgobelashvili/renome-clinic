    ...
    public static function labels(string $language = 'ka'): array
    {
        ...
        return match ($language) {
            'en' => [
                ...
                'clinic' => 'RenoMe Dental Clinic', 'address' => 'Tbilisi, 8a Navtlughi St.',
            ],
            'ru' => [
                ...
                'clinic' => 'Стоматологическая клиника RenoMe', 'address' => 'Тбилиси, ул. Навтлуги 8а',
            ],
            default => [
                ...
                'clinic' => 'რენომე სტომატოლოგია', 'address' => 'თბილისი, ნავთლუღის 8ა',
            ],
        };
    }
